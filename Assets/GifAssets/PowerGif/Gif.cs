...
namespace Assets.GifAssets.PowerGif
{
	...
	public class Gif
	{
		...
		public void EncodeParallel(Action<EncodeProgress> onProgress, MasterPalette palette = MasterPalette.DontApply)
		{
			Converter.Convert(this).ApplyPalette(palette).EncodeParallel(onProgress); // Threads are started here.
		}
	}
}